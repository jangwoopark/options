function tables = table3func(cd,dy)
T=[1/12, 4/12, 7/12]';
r=.05;
sig=.3;
P=40;
...
tables=zeros(18,2);
tables(1:3,1)=tab3cdam(1,:);
tables(4:6,1)=tab3cdam(2,:);
tables(7:9,1)=tab3cdam(3,:);
tables(10:12,1)=tab3dyam(1,:);
tables(13:15,1)=tab3dyam(2,:);
tables(16:18,1)=tab3dyam(3,:);
tables(1:3,2)=tab3cdeu(1,:);
tables(4:6,2)=tab3cdeu(2,:);
tables(7:9,2)=tab3cdeu(3,:);
tables(10:12,2)=tab3cdeu(1,:);
tables(13:15,2)=tab3cdeu(2,:);
tables(16:18,2)=tab3cdeu(3,:);